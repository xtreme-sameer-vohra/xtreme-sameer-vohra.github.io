...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9ffaaf8cbd6b68c998157a5a5545b7eea7cdf634c8d6aa8ccbb71264bd77afa0.js',function(){input.required=false;search();});}

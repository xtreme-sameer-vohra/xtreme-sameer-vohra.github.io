...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.866ec761add0be539c3cca66ca2f417d88bdf4b91884085d2943febdf17681d3.js',function(){input.required=false;search();});}

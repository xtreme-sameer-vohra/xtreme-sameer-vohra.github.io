...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3f59eb78c1025c17430eda63e97269b795998591067ca7aac2315237a4a9ffe7.js',function(){input.required=false;search();});}

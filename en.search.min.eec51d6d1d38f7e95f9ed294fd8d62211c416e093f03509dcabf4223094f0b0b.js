...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.da6a40cae39d14dfa9df53f337bf229ca1b0dc2860aeb4553efb19928fca55d8.js',function(){input.required=false;search();});}

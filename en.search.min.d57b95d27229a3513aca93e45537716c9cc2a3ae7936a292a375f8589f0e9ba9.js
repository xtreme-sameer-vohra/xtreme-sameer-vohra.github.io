...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f4b96b0629bde51a5ed5ace9a52766abfb8a7c30ea82e04fac42a6dd029aa8ca.js',function(){input.required=false;search();});}
